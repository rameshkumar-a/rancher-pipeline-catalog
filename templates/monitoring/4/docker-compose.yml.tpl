...
services:
  ...
  influxdb-continuous-query:
    ...
    command:
    - -c
    - 'wget -P /var/lib/influxdb/ ${influxdb_continuous_query} && influx -host influxdb -import -path=/var/lib/influxdb/continuous_query.txt -precision=s '
    container_name: influxdb-continuous-query
    links:
      - influxdb:influxdb
  grafana:
    restart: always
